...
class OTPVerificationScreen extends StatefulWidget {
  const OTPVerificationScreen({super.key, required this.phoneNumber, required this.userId, required this.otp});
...
class _OTPVerificationScreenState extends State<OTPVerificationScreen> {
  ...
  verifyOtp() {
    if (sixDigitOtpCode == widget.otp.toString()) {
      Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(
              builder: (_) => UserProfileSetupScreen(userId: widget.userId)),
              (route) => false);
    } else {
      showAlertDialog(context: context, message: 'Invalid OTP');
    }
  }
}
